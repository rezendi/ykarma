...
4. A [new Firebase project](https://console.firebase.google.com/) with `Email/Password` enabled at `https://console.firebase.google.com/project/your-domain/authentication/providers`
