...
const resources = {
  ...
  kr: {
    translation: {
      ...
      ‘The basic concept’: ‘커뮤니티 또는 조직의 모든 사람에게 매주 배포 할 100 개의 "카르마 코인”이 할당됩니다. 이 코인이 이용되기 위해서 다른 사람에게 코인을 주어야합니다. 코인을 받은 사람은 다양한 형태로  코인을 사용할 수 있습니다. 
(예, 하루 휴가, 컨퍼런스 티켓, 누군가와의 커피 한 잔 등.)',
