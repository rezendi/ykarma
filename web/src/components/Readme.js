    ...
    return (
      <Row>
        <Col md={12}>
          ...
          <p>For more information, see <a href="https://github.com/rezendi/ykarma/blob/master/HOWTO.md">the project README</a> or email <a href="mailto:info@ykarma.com">info@ykarma.com</a>.</p>
        </Col>
      </Row>
    );
  }
